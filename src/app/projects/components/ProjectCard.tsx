...
const ProjectCard = ({logo,title, description, techStack, link, source } : Project) => {
  return (
        <MagicCard className="cursor-pointer shadow-2xl w-[45%] max-sm:!w-fit h-[300px] border-none !bg-transparent" gradientColor= "#262626">
            <ShineBorder className="border bg-transparent h-full w-full relative rounded-lg flex flex-col justify-center items-start md:shadow-xl !bg-transparent !pointer-events-none" color={["#FF9933", "#FFFFFF", "#138808"]}>

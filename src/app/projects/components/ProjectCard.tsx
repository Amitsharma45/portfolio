            ...
            <ShineBorder className="border h-full w-full relative rounded-lg flex flex-col justify-center items-start md:shadow-xl !bg-transparent !pointer-events-none" color={["#FF9933", "#FFFFFF", "#138808"]}>
                ...
                <div className="px-3 mt-4 !pointer-events-auto">
                    <Link href={link ? link : source} underline='none'>
                        <h1 className='text-xl text-black dark:text-white font-bold tracking-tight text-start bricolage-grotesque'>{title}</h1>
                    </Link>
                ...
                <div className="flex gap-1 px-3 mt-4 flex-wrap !pointer-events-auto">
                    {
                        techStack.map((tech, idx) => (
                            <Badge key={idx} color="gray" variant="outline" highContrast className='text-[10px] bricolage-grotesque dark:hover:!bg-white hover:!bg-black hover:!text-white dark:hover:!text-black !pointer-events-auto'>
                                {tech}    
                            </Badge>
                        ))
                    }
                ...
                <div className='px-3 mt-3 !pointer-events-auto flex gap-1'>
                    {
                        ...
                        <Link href={link} target='blank'>
                            <Badge color="gray" variant="solid" highContrast className='text-[10px] py-[3px] dark:hover:bg-gray-300 bricolage-grotesque'>

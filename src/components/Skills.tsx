...
const data: string[] = ["JavaScript", "TypeScript", "C++", "Java", "Solidity", "NextJS", "React", "Prisma", "MongoDB", "PostgreSql", "MySQL", "Docker", "Redux", "Recoil", "Tailwind CSS", "Bootstrap", "NodeJS", "ExpressJS", "foundry", "Zod", "Git"];

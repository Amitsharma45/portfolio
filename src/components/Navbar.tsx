                ...
                <div className='flex justify-center px-2 items-center max-sm:gap-4 gap-8 max-[400px]:gap-4 max-[450px]:gap-5 transition-all'>
                    ...
                    <Link href="/about">
                        <Tooltip content="About">
                            <div className='hover:px-3 max-sm:hover:px-2 py-3 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all'>
                                <IoPerson className={`w-[19px] h-[19px] max-sm:w-[15px] max-sm:h-[15px] text-black dark:text-white ${pathname == '/about' ? 'dark:!text-[#FFC83D] !text-[#cc9e2b]' : ''}`}/>
                            </div>
                        </Tooltip>
                    </Link>
                    ...
                    <div className='hover:px-3 max-sm:hover:px-2 py-3 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all' onClick={toggleDarkMode}>

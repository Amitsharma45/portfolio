...
const Navbar = () => {
  return (
    <nav className='w-full py-6 flex justify-center fixed top-0'>
        ...
        <Flex gap='8' justify='center' align='center' width='1000px' className='pl-10'>
            ...
            <div><Link href="#" className='text-black dark:text-white text-[15px] sm:text-[15px] font-bold'>Projects</Link></div>
            <div><Link href="#" className='text-black dark:text-white text-[15px] sm:text-[15px] font-bold'>About</Link></div>
        </Flex>

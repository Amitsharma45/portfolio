  ...
  return (
    <nav className='w-full py-6 flex justify-center fixed top-0 z-50'>
        ...
        <Flex gap='8' justify='center' align='center' width='1000px' className='pl-10'>
            <div><Link href="/" className='text-black dark:text-white text-[15px] font-semibold tracking-tight text-center bricolage-grotesque'>Home</Link></div>
            <div><Link href="#" className='text-black dark:text-white text-[15px] font-semibold tracking-tight text-center bricolage-grotesque'>Blog</Link></div>
            <div><Link href="/projects" className='text-black dark:text-white text-[15px] font-semibold tracking-tight text-center bricolage-grotesque'>Projects</Link></div>
            <div><Link href="#" className='text-black dark:text-white text-[15px] font-semibold tracking-tight text-center bricolage-grotesque'>About</Link></div>
        </Flex>
